...
export default function Player() {
  ...
  // Local edit state (BPM, key, lyrics) — synced to/from currentTrack
  ...
  // Debounced save for track metadata
  ...
  function toggleLoop() {
    ...
    if (next) {
      // Enable: if no points set, use full track
      ...
      // Disable: clear points so next loop starts fresh
      setLoopA(null)
      setLoopB(null)
    }
  }
    ...
    <aside className="mv-player" style={{
      ...
      {!currentTrack ? (
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
          {/* Top: cover + track info + waveform + transport */}
          <div style={{ padding: '20px 20px 16px', flexShrink: 0 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
              ...
              {(loopA !== null || loopB !== null) && (
                <button onClick={toggleLoop} title="Clear loop" style={{
                  background: 'transparent', border: 'none', cursor: 'pointer',
                  color: 'var(--text-muted)', lineHeight: 0, padding: 2,
                }}>
            ...
            {activeTab === 'edit' && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                  ...
                  <input
                    ...
                    onChange={e => {
                      ...
                      if (currentTrack) scheduleSave({ bpm: e.target.value ? parseInt(e.target.value) : null })
                    }}
                    style={inputStyle}
                  />
                </div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                  ...
                  <input
                    type="text" placeholder="e.g. C minor, F# major"
                    value={key}
                    onChange={e => {
                      setKey(e.target.value)
                      if (currentTrack) scheduleSave({ key_signature: e.target.value || null })
                    }}
                    style={inputStyle}
                  />
                </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 8, height: '100%' }}>
                ...
                <textarea
                  ...
                  onChange={e => {
                    ...
                    if (currentTrack) scheduleSave({ lyrics: e.target.value || null })
                  }}
                  style={{
                    ...inputStyle,
